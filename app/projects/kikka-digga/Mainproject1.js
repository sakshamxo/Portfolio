      ...
      <div>
        ...
        <section className="mt-20 sm:mt-40">
          ...
          <p className="text-base sm:text-xl font-medium mb-4 md:mb-6 max-w-screen-lg text-[#f4e7d4]">
            Kikka Digga® is a game-changer in the world of gardening and
            ...
            standard garden forks and spades, Kikka Digga® enhances efficiency
          ...
          <p className="text-base sm:text-xl font-medium mb-4 md:mb-6 max-w-screen-lg text-[#f4e7d4]">
            I had the opportunity to build and optimize the Kikka Digga® website
