...
const Homegrids = () => {
  ...
  const projects = [
    {
      ...
      subtitle: "SaaS Shopify Application",
    },
    {
      href: "/projects/inspirationco",
      src: inspire,
      title: "The Inspiration Co.",
      subtitle: "React Website",
    },
    {
      href: "/projects/loktantra-udgosh",
      src: loktantra,
  ...
  return (
    <div
      data-aos="fade-up"
      className="grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-3 gap-10 homegrid-div"
    >
